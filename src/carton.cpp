...
//const double Carton::kMaxSize = 108;
//const double Carton::kMinSize = .007;
...
/**
 * @brief Construct a new Carton object using the constructor from ShippingItem.h
 *
...
/**
 * @brief Gives a simple output of a carton's information
 *
 * @param out The location of output
 */
void Carton::Display(ostream &out) const {
    out << fixed;
    out << setprecision(1);
    out << "Carton: " << weight_ << " lbs. " << length_ << " x " << width_ << " x " << height_ << endl;
}